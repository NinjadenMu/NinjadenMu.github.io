...
Attention heads from the models were used to study semantic grounding, and qualitative observations indicate that the models are learning semantic grounding.
To study performance and generalizability to novel forms of hate, we applied models trained only on traditional forms of hate to new hateful memes generated during the Covid-19 pandemic.  **All models performed quite poorly, indicating that current SOTA multimodal models are unable to generalize effectively to unseen forms of hate speech.**
